...
/**
 * Created by Barbados on 13/04/2014.
 */
public class Square {
    ...
    static float squareCoords[] = {
            ...
            0.1f,  1.0f, 0.0f }; // top right
    static final float mTextureCoordinates[] = {
            0, 0,
            0, 1.0f,
            1.0f, 0,
            1.0f, 1.0f
    ...
    final int mTextureStride = COORDS_PER_TEXTURE * 4;
    ...
    public void draw(float[] mvpMatrix) {
        ...
        // get handle to fragment shader's vTextureCoordinate member
        mTextureHandle = GLES20.glGetAttribLocation(mProgram, "aTextureCoordinate");
        GLES20.glActiveTexture(GLES20.GL_TEXTURE0);
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, GLRenderer.loadTexture(R.raw.test1));

        GLES20.glVertexAttribPointer(
                mTextureHandle, COORDS_PER_TEXTURE,
                GLES20.GL_FLOAT, false,
                mTextureStride, mTextureBuffer);
